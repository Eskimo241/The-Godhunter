...
namespace TheGodhunter.Items.Weapons         //The directory for your .cs and .png; Example: Mod Sources/TutorialMOD/Items
{
    public class DemonicSword : ModItem
    {
		...
		{
			// DisplayName.SetDefault("Demonic Sword");
		}
        ...
        {                                        //this is how to craft this item
            ...
            recipe.AddIngredient(ItemID.LightsBane, 1);  //this is how to add an ingredient from Terraria,  so for crafting this item you need 1 Light's Bane   
