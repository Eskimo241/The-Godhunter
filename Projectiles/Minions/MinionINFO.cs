                ...
                if (target)
                {
                    ...
                    if (Projectile.ai[1] == 0f)
                    {
                        ...
                        if (Main.myPlayer == Projectile.owner)
                        {
                            ...
                            shootVel.Normalize();
                            shootVel *= shootSpeed;
                            int proj = Projectile.NewProjectile(null, Projectile.Center.X, Projectile.Center.Y, shootVel.X, shootVel.Y, shoot, Projectile.damage, Projectile.knockBack, Main.myPlayer, 0f, 0f);
